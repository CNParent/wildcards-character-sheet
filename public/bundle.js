(function () {
	...
	function create_fragment$e(ctx) {
		...
		function select_block_type(ctx, dirty) {
			if (/*active*/ ctx[3]) return create_if_block$b;
	...
	function create_fragment$d(ctx) {
		...
		function select_block_type(ctx, dirty) {
			if (/*active*/ ctx[2]) return create_if_block$a;
	...
	function create_fragment$c(ctx) {
		...
		if (/*model*/ ctx[0].heroName !== void 0) {
			textinput0_props.content = /*model*/ ctx[0].heroName;
		}
		...
		let textinput1_props = { label: "Real Name" };

		if (/*model*/ ctx[0].name !== void 0) {
			textinput1_props.content = /*model*/ ctx[0].name;
		}
		...
		let textinput2_props = { label: "Power Level" };

		if (/*model*/ ctx[0].powerLevel !== void 0) {
			textinput2_props.content = /*model*/ ctx[0].powerLevel;
		}
		...
		let textinput3_props = { label: "Origin" };

		if (/*model*/ ctx[0].origin !== void 0) {
			textinput3_props.content = /*model*/ ctx[0].origin;
		}
		...
		return {
			...
			p(ctx, [dirty]) {
				...
				if (!updating_content && dirty & /*model*/ 1) {
					...
					textinput0_changes.content = /*model*/ ctx[0].heroName;
				...
				if (!updating_content_1 && dirty & /*model*/ 1) {
					...
					textinput1_changes.content = /*model*/ ctx[0].name;
				...
				if (!updating_content_2 && dirty & /*model*/ 1) {
					...
					textinput2_changes.content = /*model*/ ctx[0].powerLevel;
				...
				if (!updating_content_3 && dirty & /*model*/ 1) {
					...
					textinput3_changes.content = /*model*/ ctx[0].origin;
	...
	function instance$c($$self, $$props, $$invalidate) {
		...
		function textinput0_content_binding(value) {
			if ($$self.$$.not_equal(model.heroName, value)) {
				model.heroName = value;
				$$invalidate(0, model);
			}
		}
		...
		function textinput2_content_binding(value) {
			if ($$self.$$.not_equal(model.powerLevel, value)) {
				model.powerLevel = value;
				$$invalidate(0, model);
			}
		}
	...
	class TagInput extends SvelteComponent {
		constructor(options) {
			super();
			init(this, options, instance$b, create_fragment$b, safe_not_equal, { content: 0, remove: 1 });
		}
	}
	...
	class Track extends SvelteComponent {
		constructor(options) {
			super();
			init(this, options, instance$a, create_fragment$a, safe_not_equal, { model: 0, remove: 1, move: 2 });
		}
	}
	...
	class Details extends SvelteComponent {
		constructor(options) {
			super();
			init(this, options, instance$8, create_fragment$8, safe_not_equal, { title: 1, open: 0, size: 2 });
		}
	}
	...
	function create_fragment$7(ctx) {
		...
		function select_block_type(ctx, dirty) {
			if (/*alert*/ ctx[3]?.success) return create_if_block$5;
	...
	function create_each_block$3(ctx) {
		...
		return {
			c() {
				...
				button.innerHTML = ``;
				attr(button, "class", "bubble btn border border-dark");
				toggle_class(button, "btn-dark", /*model*/ ctx[0].level > /*i*/ ctx[14]);
				toggle_class(button, "btn-light", /*model*/ ctx[0].level <= /*i*/ ctx[14]);
			},
			m(target, anchor) {
				insert(target, button, anchor);
	...
	function instance$4($$self, $$props, $$invalidate) {
		...
		$$invalidate(4, arr = [...new Array(maxMark$1)]);
	...
	class Skill extends SvelteComponent {
		constructor(options) {
			super();
			init(this, options, instance$4, create_fragment$4, safe_not_equal, { model: 0, remove: 1 });
		}
	}

	/* src\components\Skills.svelte generated by Svelte v4.2.19 */
	...
	function create_each_block$2(ctx) {
		...
		return {
			...
			p(ctx, dirty) {
				...
				if (dirty & /*model*/ 1) skill_1_changes.model = /*item*/ ctx[4];
	...
	function create_fragment$3(ctx) {
		...
		return {
			c() {
				...
				each_1_anchor = empty();
				attr(button0, "class", "btn btn-light badge");
				attr(button1, "class", "btn btn-light badge");
			},
			m(target, anchor) {
				insert(target, button0, anchor);
				insert(target, t1, anchor);
				...
				if (!mounted) {
					dispose = [
						...
						listen(button1, "click", /*sort*/ ctx[3])
					];
	...
	/* src\components\Weakness.svelte generated by Svelte v4.2.19 */
	...
	class Weakness extends SvelteComponent {
		constructor(options) {
			super();
			init(this, options, instance$2, create_fragment$2, safe_not_equal, { model: 0, remove: 1 });
		}
	}

	/* src\components\Weaknesses.svelte generated by Svelte v4.2.19 */
	...
	function create_each_block(ctx) {
		...
		return {
			c() {
				create_component(weakness_1.$$.fragment);
			},
			m(target, anchor) {
				mount_component(weakness_1, target, anchor);
				current = true;
			},
			p(ctx, dirty) {
				const weakness_1_changes = {};
				if (dirty & /*model*/ 1) weakness_1_changes.model = /*item*/ ctx[3];
				weakness_1.$set(weakness_1_changes);
			},
			i(local) {
				if (current) return;
				transition_in(weakness_1.$$.fragment, local);
				current = true;
			},
			o(local) {
				transition_out(weakness_1.$$.fragment, local);
				current = false;
			},
			d(detaching) {
				destroy_component(weakness_1, detaching);
			}
		};
	}
	...
	function create_fragment$1(ctx) {
		...
		let each_1_anchor;
		let current;
		let if_block = /*model*/ ctx[0].length < maxMires && create_if_block$1(ctx);
		let each_value = ensure_array_like(/*model*/ ctx[0]);
		let each_blocks = [];
	...
	class Weaknesses extends SvelteComponent {
		constructor(options) {
			super();
	...
	// (33:2) <Details title="Attributes" size="col-lg-3 col-12">
	function create_default_slot_11(ctx) {
		...
		return {
			...
			p(ctx, dirty) {
				...
				if (dirty & /*model*/ 1) collection_changes.model = /*model*/ ctx[0].attributes;
	...
	// (45:2) <Details title="Weaknesses" size="col-lg-3 col-12">
	function create_default_slot_9(ctx) {
		let weaknesses;
		let current;

		weaknesses = new Weaknesses({
				props: { model: /*model*/ ctx[0].weaknesses }
			});

		return {
			c() {
				create_component(weaknesses.$$.fragment);
			},
			m(target, anchor) {
				mount_component(weaknesses, target, anchor);
				current = true;
			},
			p(ctx, dirty) {
				const weaknesses_changes = {};
				if (dirty & /*model*/ 1) weaknesses_changes.model = /*model*/ ctx[0].weaknesses;
				weaknesses.$set(weaknesses_changes);
			},
			i(local) {
				if (current) return;
				transition_in(weaknesses.$$.fragment, local);
				current = true;
			},
			o(local) {
				transition_out(weaknesses.$$.fragment, local);
				current = false;
			},
			d(detaching) {
				destroy_component(weaknesses, detaching);
			}
		};
	}

	// (54:3) <Details title="Used" size="col-12">
	...
	// (64:3) <Details title="Used" size="col-12">
	...
	// (58:2) <Details title="Minor Milestones" size="col-lg-3 col-12">
	...
	// (68:2) <Details title="Skills" size="col-lg-3 col-12">
	function create_default_slot_4(ctx) {
		let skills;
		let current;

		skills = new Skills({
				props: { model: /*model*/ ctx[0].skills }
			});
		...
		return {
			...
			p(ctx, dirty) {
				...
				if (dirty & /*model*/ 1) skills_changes.model = /*model*/ ctx[0].skills;
	...
	// (71:2) <Details title="Quips" size="col-lg-3 col-12">
	function create_default_slot_3(ctx) {
		...
		collection = new Collection({
				props: {
					model: /*model*/ ctx[0].resources.quips,
					itemType: collectionTypes.simple
				}
			});
		...
		return {
			...
			p(ctx, dirty) {
				const collection_changes = {};
				if (dirty & /*model*/ 1) collection_changes.model = /*model*/ ctx[0].resources.quips;
				collection.$set(collection_changes);
			},
			i(local) {
				if (current) return;

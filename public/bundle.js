(function () {
	...
	class Navbar extends SvelteComponent {
		constructor(options) {
			super();
			init(this, options, instance$6, create_fragment$6, safe_not_equal, { model: 14 });
		}
	}
	...
	class Note extends SvelteComponent {
		constructor(options) {
			super();
			init(this, options, instance$5, create_fragment$5, safe_not_equal, { actions: 1, note: 0, highlight: 2 });
		}
	}
	...
	class Notes extends SvelteComponent {
		constructor(options) {
			super();
			init(this, options, instance$4, create_fragment$4, safe_not_equal, { notes: 7 });
		}
	}
	...
	function create_each_block(ctx) {
		let skill_1;
		let current;
		skill_1 = new Skill({ props: { model: /*skill*/ ctx[4] } });
		...
		return {
			...
			p(ctx, dirty) {
				...
				if (dirty & /*model*/ 1) skill_1_changes.model = /*skill*/ ctx[4];
	...
	function create_default_slot_4(ctx) {
		let div;
		let current;
		let each_value = ensure_array_like(/*model*/ ctx[0].skills);
		let each_blocks = [];
		...
		return {
			...
			p(ctx, dirty) {
				if (dirty & /*model*/ 1) {
					each_value = ensure_array_like(/*model*/ ctx[0].skills);
					let i;
	...
	// (69:2) <Details title="Quips" size="col-lg-3 col-12">
	...
	// (78:2) <Details title="Temporary Tracks">
